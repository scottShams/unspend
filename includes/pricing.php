        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="bg-purple-900 p-8 rounded-xl shadow-2xl transform scale-105 border-4 border-amber-400">
                    ...
                    <a href="#" onclick="upgradePlan('monthly')" class="bg-amber-500 hover:bg-amber-600 text-white font-bold py-3 px-8 rounded-lg shadow-md block" data-user-has-account="<?php echo $userHasAccount ? 'true' : 'false'; ?>">Subscribe Now</a>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-2xl border-4 border-yellow-400">
                    ...
                    <a href="#" onclick="upgradePlan('annual')" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-lg shadow-md block" data-user-has-account="<?php echo $userHasAccount ? 'true' : 'false'; ?>">Subscribe Annual & Save</a>
                </div>
            </div>
        </div>
    </section>
